...
# Title: LAB1_ParteA
# Author: DiegoGarcia_DiegoEspinel
...
class LAB_COMU1_G2(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "LAB1_ParteA", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("LAB1_ParteA")
        ...
        self.settings = Qt.QSettings("GNU Radio", "LAB_COMU1_G2")
        ...
        self._Amplitud_range = qtgui.Range(0, 3, 0.1, 0, 200)
...
def main(top_block_cls=LAB_COMU1_G2, options=None):
