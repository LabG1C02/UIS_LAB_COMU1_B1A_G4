...
class Parte_B_WavFileSource(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "LAB1_ParteB_Punto5", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("LAB1_ParteB_Punto5")
        ...
        self.settings = Qt.QSettings("GNU Radio", "Parte_B_WavFileSource")
        ...
        self._Const_range = qtgui.Range(0, 2, 1, 1, 200)
        self._Const_win = qtgui.RangeWidget(self._Const_range, self.set_Const, "Multiply Const", "counter_slider", float, QtCore.Qt.Horizontal)
...
def main(top_block_cls=Parte_B_WavFileSource, options=None):
